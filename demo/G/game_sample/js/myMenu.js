var MyMenu = Framework.exClass(Framework.GameMainMenu , {
    ...
    initializeProgressResource: function() {
        this.loading = new Framework.Sprite(define.imagePath + 'loa.jpg');
        this.loading.scale = 0.85;
        this.loading.position = {x: Framework.Game.getCanvasWidth() / 2 , y: Framework.Game.getCanvasHeight() / 2};

        //為了或得到this.loading這個Sprite的絕對位置, 故需要先計算一次(在Game Loop執行時, 則會自動計算,
        //但因為loadingProgress只支援draw故需要自行計算)
    },
    ...
    load: function() {
        this.menu = new Framework.Sprite(define.imagePath + 'start.jpg');
    },
